...
declare @recipient varchar(max) = ''--declare @cc varchar(max)= ''
--declare @bcc varchar(max)= ''
declare @sub varchar(100)='Object Modification Report - DDL execution in last 24 Hours'
declare @body nvarchar(max)
declare @xml nvarchar(max)
declare @sql table(DatabaseName varchar(100), LoginName varchar(100), HostName varchar(100), StartTime datetime, EventclassDesc varchar(50),ObjectTypeDesc varchar(50),objectname varchar(140))
...
SELECT @xml = Cast((SELECT [DatabaseName] AS 'td','', [LoginName] AS 'td',
'',
[HostName] AS 'td',
'',
[StartTime] AS 'td',
'',
[EventclassDesc] AS 'td',
'',
[ObjectTypeDesc] AS 'td',
'',
[objectname] AS 'td'
FROM @sql
...
<th>HostName</th>
<th>StartTime</th>
<th>EventClassDesc</th>
<th>ObjectTypeDesc</th>
<th>ObjectName</th>
</tr>'
SET @body = @body + @xml + '      
</table>  
