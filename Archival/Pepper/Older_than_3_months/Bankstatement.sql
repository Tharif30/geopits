...
/****** Object:  StoredProcedure [dbo].[MerchantResponseDetails]    Script Date: 27-08-2025 15:08:53 ******/
SET ANSI_NULLS ON
GO
...
Create     PROCEDURE [dbo].[BankStatement]
AS
BEGIN
    SET NOCOUNT ON;
...
[TransactionPeriod],[TransactionPeriodFrom],[TransactionPeriodTo],[StatementFormat],[BankSealAndSignature],[AccountOpeningDate],
[StatementDate],[BankName],[ApplicationNo],[BankID],[CreatedOn],[BankPancardNo],[IPAddress],
