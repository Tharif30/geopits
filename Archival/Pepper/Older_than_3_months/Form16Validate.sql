...
Create     PROCEDURE [dbo].[Form16Validate]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[Form16Validate]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[Form16Validate]';
...
[Form16ValidateID],[Form16EmployeeName],[Form16EmployeeAddress],[Form16EmployeePanNumber],[Form16EmployerName],
[Form16EmployerAddress],[Form16employerPanNumber],[Form16EmployerTanNumber],[Form16Designation],[Form16AssessmentYear],
[ApplicationNo],[CreatedBy],[CreatedOn],[ModifiedBy],[ModifiedOn],[DeletedBy],[DeletedOn],[Deleted],[IPAddress],
[Form16StartDate],[Form16EndDate],[LoanguardId],[DocumentIndex],[OptingForTaxation],[Form16AssociatedWith]  
...
OUTPUT 
	   Deleted.[Form16ValidateID]
      ,Deleted.[Form16EmployeeName]
      ,Deleted.[Form16EmployeeAddress]
      ,Deleted.[Form16EmployeePanNumber]
      ,Deleted.[Form16EmployerName]
      ,Deleted.[Form16EmployerAddress]
      ,Deleted.[Form16employerPanNumber]
      ,Deleted.[Form16EmployerTanNumber]
      ,Deleted.[Form16Designation]
      ,Deleted.[Form16AssessmentYear]
      ...
      ,Deleted.[Deleted]
      ,Deleted.[IPAddress]
      ,Deleted.[Form16StartDate]
      ,Deleted.[Form16EndDate]
      ,Deleted.[LoanguardId]
      ,Deleted.[DocumentIndex]
      ,Deleted.[OptingForTaxation]
      ,Deleted.[Form16AssociatedWith]
