...
BEGIN
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[ITR]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[ITR]';
...
[ITRID],[ITREmployeeName],[ITREmployeeAddress],[ITREmployeePanNumber],[ITRDateofFilling],[ITRAssesementYear],
[ITRIPAddress],[ITRBarCode],[ITREITRfilled],[ITRAckoledgeNo],[ApplicationNo],[IPAddress],[CreatedBy],[CreatedOn],[ITRwardCircle],
[ITRStatus],[ITRType],[ITRCountOfPancardNo],[LoanguardId],[ITRAdharNO],[ITRFormNO],
[DocumentIndex],[ITRStandard],[ITRSignDate],[ITRAckoledgeNoTwo],[CopyFirstAckNo]    
...
OUTPUT 
	  Deleted.[ITRID]
      ,Deleted.[ITREmployeeName]
      ,Deleted.[ITREmployeeAddress]
      ,Deleted.[ITREmployeePanNumber]
      ,Deleted.[ITRDateofFilling]
      ,Deleted.[ITRAssesementYear]
      ,Deleted.[ITRIPAddress]
      ,Deleted.[ITRBarCode]
      ,Deleted.[ITREITRfilled]
      ,Deleted.[ITRAckoledgeNo]
      ,Deleted.[ApplicationNo]
      ,Deleted.[IPAddress]
      ,Deleted.[CreatedBy]
      ,Deleted.[CreatedOn]
      ,Deleted.[ITRwardCircle]
      ,Deleted.[ITRStatus]
      ,Deleted.[ITRType]
      ,Deleted.[ITRCountOfPancardNo]
      ,Deleted.[LoanguardId]
      ,Deleted.[ITRAdharNO]
      ,Deleted.[ITRFormNO]
      ...
      ,Deleted.[ITRStandard]
      ,Deleted.[ITRSignDate]
      ,Deleted.[ITRAckoledgeNoTwo]
      ,Deleted.[CopyFirstAckNo] 
