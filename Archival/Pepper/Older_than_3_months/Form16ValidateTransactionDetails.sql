...
Create     PROCEDURE [dbo].[Form16TransactionDetails]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[Form16TransactionDetails]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[Form16TransactionDetails]';
