...
Create     PROCEDURE [dbo].[ITRValidateTransactionDetails]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[ITRValidateTransactionDetails]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[ITRValidateTransactionDetails]';
...
[ITRValidateTransactionId],[ITRValidateID],[HeadId],[HeadName],[HeadValue],[CreatedBy],[CreatedOn],[EnteredHeadValue]
...
OUTPUT 
	Deleted.[ITRValidateTransactionId],
	Deleted.[ITRValidateID],
	Deleted.[HeadId],
	Deleted.[HeadName],
	Deleted.[HeadValue],
	Deleted.[CreatedBy],
	Deleted.[CreatedOn],
	Deleted.[EnteredHeadValue]
