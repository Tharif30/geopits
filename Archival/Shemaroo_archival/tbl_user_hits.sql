...
create or alter PROCEDURE [dbo].[tbl_user_hits_Archive]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    -- 1. Declare Variables
    --===============================
    DECLARE @SourceTableName NVARCHAR(128) = 'vasdev_sel.dbo.tbl_user_hits';
    DECLARE @DestinationTableName NVARCHAR(128) = 'vasdev_sel.dbo.tbl_user_hits_archive_2024';
    DECLARE @sSQL NVARCHAR(MAX);

    --===============================
    --Given condition
    --select count(1) from tbl_user_hits tuh where tuh.hit_createddate < '2024-12-31 23:59:59'
    --===============================

    DECLARE @filter NVARCHAR(MAX) = 'hit_createddate < ''2024-12-31 23:59:59''';

    DECLARE @column NVARCHAR(MAX) = 'hit_createddate';
