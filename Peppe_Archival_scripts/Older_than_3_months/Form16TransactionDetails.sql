...
Create     PROCEDURE [dbo].[Form16ValidateTransactionDetails]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[Form16ValidateTransactionDetails]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[Form16ValidateTransactionDetails]';
...
[Form16TransactionId],[Form16ID],[HeadId],[HeadName],[HeadValue],[CreatedBy],[CreatedOn]
...
OUTPUT 
Deleted.[Form16ValidateTransactionId],
