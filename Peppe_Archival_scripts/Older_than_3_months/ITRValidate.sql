...
Create OR ALTER    PROCEDURE [dbo].[ITRValidate]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[ITRValidate]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[ITRValidate]';
	...
	SET @sSQL = 
N'IF OBJECT_ID(''tempdb..#Staging_ITR16Validate'') IS NOT NULL
    DROP TABLE #Staging_ITR16Validate;

CREATE TABLE #Staging_ITR16Validate (
	[ITRValidateID] [int] ,
	[ITREmployeeName] [varchar](100) NULL,
	[ITREmployeeAddress] [varchar](300) NULL,
	[ITREmployeePanNumber] [varchar](10) NULL,
	[ITRDateofFilling] [varchar](50) NULL,
	[ITRAssesementYear] [varchar](10) NULL,
	[ITRIPAddress] [varchar](20) NULL,
	[ITRBarCode] [varchar](100) NULL,
	[ITREITRfilled] [bit] NULL,
	[ITRAckoledgeNo] [varchar](20) NULL,
	...
	[ITRwardCircle] [varchar](50) NULL,
	[ITRStatus] [varchar](15) NULL,
	[ITRType] [varchar](15) NULL,
	[LoanguardId] [varchar](50) NULL,
	[ITRAdharNO] [varchar](15) NULL,
	[ITRFormNO] [varchar](10) NULL,
	[DocumentIndex] [int] NULL,
	[ITRStandard] [varchar](20) NULL,
	[ITRSignDate] [varchar](15) NULL,
	[SelAssessmentYear] [varchar](10) NULL,
	[ITRAckoledgeNoTwo] [varchar](20) NULL,
	[CopyFirstAckNo] [int] NULL
);
...
OUTPUT DELETED.*
	INTO #Staging_ITR16Validate;

SET IDENTITY_INSERT ' + @DestinationTableName + N' ON;

INSERT INTO ' + @DestinationTableName + N'(
[ITRValidateID],[ITREmployeeName],[ITREmployeeAddress],[ITREmployeePanNumber],[ITRDateofFilling],[ITRAssesementYear],
[ITRIPAddress],[ITRBarCode],[ITREITRfilled],[ITRAckoledgeNo],[ApplicationNo],[CreatedBy],[CreatedOn],[ModifiedBy],
[ModifiedOn],[DeletedBy],[DeletedOn],[Deleted],[IPAddress],[ITRwardCircle],[ITRStatus],[ITRType],[LoanguardId],[ITRAdharNO],[ITRFormNO],[DocumentIndex],
[ITRStandard],[ITRSignDate],[SelAssessmentYear],[ITRAckoledgeNoTwo],[CopyFirstAckNo]
    )SELECT * FROM #Staging_ITR16Validate;
