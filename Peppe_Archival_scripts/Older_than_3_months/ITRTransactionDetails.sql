...
Create     PROCEDURE [dbo].[ITRTransactionDetails]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[ITRTransactionDetails]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[ITRTransactionDetails]';
...
[ITRTransactionId],[ITRID],[HeadId],[HeadName],[HeadValue],[CreatedBy],[CreatedOn]
