...
BEGIN
    ...
    DECLARE @SourceTableName SYSNAME = ' [DBLoanguard].[dbo].[Form16]';
    DECLARE @DestinationTableName SYSNAME = '[DBLoanguardHistory].[dbo].[Form16]';
...
[Form16ID],[Form16EmployeeName],[Form16EmployeeAddress],[Form16EmployeePanNumber],[Form16EmployerName],
[Form16EmployerAddress],[Form16employerPanNumber],[Form16EmployerTanNumber],[Form16Designation],[Form16AssessmentYear],
[ApplicationNo],[IPAddress],[Form16StartDate],
[Form16EndDate],[LoanguardId],[DocumentIndex],[OptingForTaxation],[Form16AssociatedWith],[CreatedOn]   
